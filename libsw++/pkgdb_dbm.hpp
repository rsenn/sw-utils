...
#ifndef SWXX_PKGDB_DBM_H
#define SWXX_PKGDB_DBM_H
...
#define PKG_DB_DBM PKG_DIR"/dbm.bin"

using namespace std;

class pkgdb_dbm : public pkgdb {
public:
	explicit pkgdb_dbm();
	virtual ~pkgdb_dbm();
...
class pkgdb_dbm_lock : public pkgdb_lock
{
public:
	explicit pkgdb_dbm_lock(const string& root, bool exclusive = true);
	virtual ~pkgdb_dbm_lock();
